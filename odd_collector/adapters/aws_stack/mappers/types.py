...
class DataEntityType(Enum):
    ...
    LAMBDA_PERMISSION = 2
    LAMBDA_VERSION = 3
    StepFunctions_StateMachine = 4

RESOURCE_TYPES_AWS_TO_ODD: Dict[str, DataEntityType] = {
    "LAMBDA_FUNCTION": DataEntityType.LAMBDA_FUNCTION,
    "LAMBDA_PERMISSION": DataEntityType.LAMBDA_PERMISSION,
    "LAMBDA_VERSION": DataEntityType.LAMBDA_VERSION,
    "StepFunctions_StateMachine": DataEntityType.StepFunctions_StateMachine,
    "UNKNOWN": DataEntityType.UNKNOWN
}
